...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item @if($title == 'Tree') active @endif ">
                <a class="nav-link" href="/tree">
                    Tree @if($title == 'Tree')<span class="sr-only">(current)</span>@endif
                </a>
            </li>
            <li class="nav-item @if($title == 'List') active @endif ">
                <a class="nav-link" href="/list">
                    List @if($title == 'List')<span class="sr-only">(current)</span>@endif
                </a>
            </li>
            {{--<li class="nav-item">--}}
